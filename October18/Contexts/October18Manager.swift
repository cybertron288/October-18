...
// MARK: October18Manager
final class October18Manager {
    
    private enum Constant {
        static let bundleId = "oedrommcarrasco.october18"
    ...
    lazy var currentVersion: String = {
        // We are running from the October18 screensaver itself
